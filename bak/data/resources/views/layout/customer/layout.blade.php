		...
		<!-- <nav class="navbar navbar-default">
		  <div class="container-fluid">
		    <div class="navbar-header">
		      ...
		      <a class="navbar-brand" href="{{ url('/') }}">RideApp</a>
		    </div>
		    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		      <ul class="nav navbar-nav navbar-right">
		      	@if(Auth::user())
			      	<li> <a href="{{ route('customer.dashboard') }}">Home</a></li>
			      	<li> <a href="{{ route('customer.mytrip') }}">My Trip</a></li>
			      	<li> <a href="{{ route('customer.mywallet') }}">My Wallat</a></li>
			      	<li> <a href="{{ route('customer.share') }}">Sharing Code & Invitation</a></li>
			      	<li> <a href="{{ route('customer.promotion') }}">Promotion</a></li>
			      	<li> <a href="{{ route('customer.notification') }}">Notification</a></li>
			      	<li> <a href="{{ route('customer.dashboard') }}">Contact US</a></li>
			      	<li> <a href="{{ route('customer.dashboard') }}">FAQ</a></li>
