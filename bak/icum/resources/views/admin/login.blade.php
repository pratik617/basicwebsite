...
<body class="header-filter purple-filter">
<!-- Preloader -->
<div class="preloader">
...
<section id="wrapper" class="login-register">
  <div class="login-box">
    <div class="white-box">
      <form id="frm-login" class="form-horizontal form-material" method="POST" action="{{ route('admin.login.submit') }}">
        @csrf
        <div class="form-group logo-box">
          <div class="col-xs-12 text-center">
            <div class="user-thumb text-center">
              <img alt="thumbnail" src="{{ asset('images/logo.png') }}">
            </div>
          </div>
        </div>
        <br>
